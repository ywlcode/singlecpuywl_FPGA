...
#
# Generated by Vivado on Tue May 10 20:07:47 +0800 2022
...
# Script info
echo -e "ram_code.sh - Script generated by export_simulation (Vivado v2019.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_code xil_defaultlib.ram_code xil_defaultlib.glbl -log elaborate.log
}
